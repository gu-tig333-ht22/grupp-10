...
class Fetcher {
  static Future searchRecipe(query, cuisineType, filters) async {
    ...
    var base_url =
        'https://api.edamam.com/api/recipes/v2?type=public&app_id=607e9ef0&app_key=36dd52ad40a313ff492876bb59038867%09&imageSize=THUMBNAIL&field=label&field=image&field=source&field=healthLabels&field=ingredientLines&field=calories&field=uri';
  ...
  static Future fetchRecipe(id) async {
    var recipe_url =
        'https://api.edamam.com/api/recipes/v2/${id}?type=public&app_id=607e9ef0&app_key=36dd52ad40a313ff492876bb59038867%09&field=uri&field=label&field=image&field=images&field=source&field=url&field=healthLabels&field=ingredientLines&field=calories&field=cuisineType';
